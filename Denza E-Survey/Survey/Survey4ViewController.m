...
@interface Survey4ViewController ()

@end

@implementation Survey4ViewController
...
- (IBAction)next_Survey:(id)sender {
    //Load next question
    Survey5ViewController *objGroupView = [[Survey5ViewController alloc] initWithNibName:@"Survey5ViewController" bundle:nil];
