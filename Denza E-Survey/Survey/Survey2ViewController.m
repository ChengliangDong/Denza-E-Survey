...
@interface Survey2ViewController ()

@end

@implementation Survey2ViewController
...
- (IBAction)next_Survey:(id)sender {
    //Load next question
    Survey3ViewController *objGroupView = [[Survey3ViewController alloc] initWithNibName:@"Survey3ViewController" bundle:nil];
